...
PANEL_DEFAULTS_EN = {
    ...
    "texture_1": "seamless tileable visible repeat pattern, stable low-to-medium density, clearly repeatable elements, commercial apparel base fabric, no text ",
    "texture_2": "seamless tileable visible repeat pattern, stable medium density, clearly repeatable elements, commercial apparel base fabric, no text ",
    "texture_3": "seamless tileable visible repeat pattern, stable controlled density, clearly repeatable elements, commercial apparel base fabric, no text "
}
